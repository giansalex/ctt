...
namespace ConfigTransformationTool.Base
{
	...
	public class TransformationLogger : IXmlTransformationLogger
	{
		...
		{
			Log.WarnFormat(string.Format("File: {0}, LineNumber: {1}, LinePosition: {2}, Message: {3}", file, lineNumber, linePosition, message), messageArgs);
		}
		...
		{
			Log.ErrorFormat(string.Format("File: {0}, LineNumber: {1}, LinePosition: {2}, Message: {3}", file, lineNumber, linePosition, message), messageArgs);
		}
		...
		{
			Log.Error(string.Format("File: {0}, LineNumber: {1}, LinePosition: {2}", file, lineNumber, linePosition), ex);
		}
